...
export class ImportPage extends React.Component {
  ...
  importData = () => {
    ...
    const identiferField = this.state.filterImport !== '' ? (mappedData && Array.isArray(mappedData) && mappedData.length && mappedData[0].code) : '';
    const importSelect =
  ...
  getStepContent = step => {
    ...
    const list = dataField && dataField.listDisplay && dataField.listDisplay.type && dataField.listDisplay.type.fields &&
      dataField.listDisplay.type.fields.type && dataField.listDisplay.type.fields.type.columns || [];
      ...
      case 2:
        ...
        return (
          <div>
            ...
            {
              <React.Fragment>
                <FormControl variant="contained" style={{ marginBottom: 20, minWidth: 400 }}>
