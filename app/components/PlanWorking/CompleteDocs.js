...
const DocumentAssignModal = props => {
  const { open, docIds, onChangeSnackbar, template, currentRole, typePage = "", isAuthory = false, } = props;
  ...
  return (
    ...
    }} saveText="Hoàn thành" disableSave={!docIds || !docIds.length} onClose={() => props.onClose && props.onClose()} open={open} style={{ position: 'relative' }}>
      {/* <DepartmentSelect
        title=""
