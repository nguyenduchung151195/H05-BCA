...
class ListPage extends React.PureComponent {
  ...
  handleSearch = e => {
    let value;
    // this.setState({ filters: ['toBookCode', 'abstractNote'] });
                ...
                {disableSearch ? null : client ? (
                  ...
                  <GridItem md={12} sm={12} style={{ display: 'flex', alignItems: 'center' }} container>
                    {this.props.hideSearch ? null : this.props.notChangeSearch ? (
                      ...
                      <>
                        <GridItem xs={2} style={{ margin: "-7px 7px 0px -7px" }}>
                          <TextFieldUI
                            variant="outlined"
                            InputProps={{
                              endAdornment: (
...
ListPage.defaultProps = {
  ...
  filter: {},
  treeName: 'name',
  columnExtensions: [{ columnName: 'abstractNote', width: 300 }, { columnName: 'stt', width: 70 }],
  rightColumns: ['edit'],
  reload: false,
  perPage: 50,
  status: 'crmStatus',
