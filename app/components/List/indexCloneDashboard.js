...
const ExportTable = React.memo(
  ({ filters, filter, filter1, filter2, open, onClose, apiUrl, moduleCode, kanban, viewConfigUpdateTime, exportUrl }) => {
    ...
    const [viewConfigData, setViewConfigData] = useState([
      { name: "stt", order: 1, title: "STT", title_init: "STT", type: "String", width: 50 },
      { name: "nameOrg", order: 2, title: "Tên đơn vị", title_init: "STT", type: "String", width: 50 },
      { name: "count", order: 3, title: "Tổng nhiệm vụ", title_init: "STT", type: "String", width: 50 },

      { name: "countNoComplete", order: 4, title: "Số nhiệm vụ", title_init: "STT", type: "String", width: 50 },
      { name: "countNoCompleteNoDeadline", order: 5, title: "Không hạn", title_init: "STT", type: "String", width: 50 },
      { name: "countNoCompleteOutDeadline", order: 6, title: "Quá hạn", title_init: "STT", type: "String", width: 50 },
      { name: "countNoCompleteInDeadline", order: 7, title: "Trong hạn", title_init: "STT", type: "String", width: 50 },

      { name: "countComplete", order: 8, title: "Số nhiệm vụ", title_init: "STT", type: "String", width: 50 },
      { name: "countCompleteNoDeadline", order: 9, title: "Không hạn", title_init: "STT", type: "String", width: 50 },
      { name: "countCompleteOutDeadline", order: 10, title: "Quá hạn", title_init: "STT", type: "String", width: 50 },
      { name: "countCompleteInDeadline", order: 11, title: "Trong hạn", title_init: "STT", type: "String", width: 50 },
    ...
    const getDataFirstTime = async () => {
      try {
        ...
        if (res.count > numberRecordLimitBackEnd) {
          ...
          listDer && Array.isArray(listDer) && listDer.length > 0 && listDer.map((el) => {
            listData && Array.isArray(listData) && listData.length > 0 && listData.map((ell) => {
          ...
          setDataPageExcell({ ...dataPageExcell, data: data, totalPage: 1, pageNumber: 1, numberOrderFirstPage: 1 });
    ...
    const getDataPagination = async (skip, limit, totalPage, pageNumber) => {
      ...
      try {
        ...
        if (data.length === 0) data = listData
        setDataPageExcell({ ...dataPageExcell, data: data, totalPage: totalPage, pageNumber: pageNumber, numberOrderFirstPage: skip + 1 });
            ...
            <GridItem md={this.props.reports ? 9 : 12} sm={this.props.reports ? 9 : 12}>
              <div style={{ display: 'flex', alignItems: 'center' }}>
                {disableSearch ? null : client ? (
                  ...
                  /> */}
                    {
                      console.log(columns, "columns", _.sortBy(columns, ['filterOrder']))
                    }
...
const GridList = React.memo(
  ({
    ...
    const [newCls, setNewCls] = React.useState(
      disableSTT ?
        [
          { name: "nameOrg", title: "Đơn vị" },

          { name: "countComplete", title: "Tổng số" },
          { name: "countCompleteOutDeadline", title: "Quá hạn" },

          { name: "countNoComplete", title: "Tổng số" },
          { name: "countNoCompleteOutDeadline", title: "Quá hạn" },

          { name: "count", title: "Tổng số" },
          { name: "countProcessingDoc", title: "Chờ xử lý" },
          { name: "countPromulgateDoc", title: "Ban hành" },

          { name: "countTasks", title: "Tổng số" },
          { name: "countNoProcessTasks", title: "Chưa xử lý" },
          { name: "countProcessingTasks", title: "Đang xử lý" },
          { name: "countCompleteTasks", title: "Hoàn thành" },
        ]
        :
        []
    );
    ...
    const [tableColumnExtensions] = useState([
      { columnName: "nameOrg", width: 150 },
      { columnName: "countComplete", align: 'center', width: 150 },
      { columnName: "countCompleteOutDeadline", align: 'center', width: 150 },

      { columnName: "countNoComplete", align: 'center', width: 150 },
      { columnName: "countNoCompleteOutDeadline", align: 'center', width: 150 },

      { columnName: "count", align: 'center', width: 150 },
      { columnName: "countProcessingDoc", align: 'center', width: 150 },
      { columnName: "countPromulgateDoc", align: 'center', width: 150 },

      { columnName: "countTasks", align: 'center', width: 150 },
      { columnName: "countNoProcessTasks", align: 'center', width: 150 },
      { columnName: "countProcessingTasks", align: 'center', width: 150 },
      { columnName: "countCompleteTasks", align: 'center', width: 150 },
    ])
    ...
    const [leftColumns] = useState(['nameOrg'])
    const [newcollumm, setNewcollumm] = useState([
      {
        title: (<div style={{ cursor: "pointer" }} onClick={() => history.push({
      ...
      },
      {
        ...
        children: [
          { columnName: 'count' },
          { columnName: 'countProcessingDoc' },
          { columnName: 'countPromulgateDoc' },
        ]
      },
      {
        title: (<div style={{ cursor: "pointer" }} onClick={() => history.push({
        ...
        children: [
          { columnName: 'countTasks' },
          { columnName: 'countNoProcessTasks' },
          { columnName: 'countProcessingTasks' },
          { columnName: 'countCompleteTasks' },
        ]
      }
    ]);
    ...
    //     },
    //     {
    //       title: "NV dã hoàn thành (đạt tỷ lệ %)",
    //       children: [
    //         { columnName: 'countNoComplete' },
    ...
    //     },
    //   ]
    //   setNewcollumm(NEW_COLUMN)
    //   const newcl = [
    //     { name: "stt", order: 1, title: "STT", title_init: "STT", type: "String", width: "10px" },
    //     { name: "nameOrg", order: 2, title: "Tên đơn vị", title_init: "STT", type: "String", width: "10px" },
    //     { name: "count", order: 3, title: "Tổng nhiệm vụ", title_init: "STT", type: "String", width: "10px" },
    //     { name: "countComplete", order: 4, title: "Số nhiệm vụ", title_init: "STT", type: "String", width: "10px" },
    //     { name: "countCompleteNoDeadline", order: 5, title: "Không hạn", title_init: "STT", type: "String", width: "10px" },
    //     { name: "countCompleteOutDeadline", order: 6, title: "Quá hạn", title_init: "STT", type: "String", width: "10px" },
    //     { name: "countCompleteInDeadline", order: 7, title: "Trong hạn", title_init: "STT", type: "String", width: "10px" },
    //     { name: "countNoComplete", order: 8, title: "Số nhiệm vụ", title_init: "STT", type: "String", width: "10px" },
    //     { name: "countNoCompleteNoDeadline", order: 9, title: "Không hạn", title_init: "STT", type: "String", width: "10px" },
    //     { name: "countNoCompleteOutDeadline", order: 10, title: "Quá hạn", title_init: "STT", type: "String", width: "10px" },
    //     { name: "countNoCompleteInDeadline", order: 11, title: "Trong hạn", title_init: "STT", type: "String", width: "10px" },
    //   ]
    //   setNewCls(newcl)
    // }, [])
    useEffect(
    ...
    return (
      <div ref={containerRef} style={{ width: '100%' }} className="ktCustom">
        <Paper className="CustomlistTableDasboard" md={12} style={{ overflow: 'auto', boxShadow: 'none' }}>
          {!loading ? (
            <Grid className="CustomlistTableDasboard" rows={rows} columns={newCls}>
...
ListPage.defaultProps = {
  ...
  treeName: 'name',
  // columnExtensions: [
  //   { columnName: "countNoComplete", width: 100 },
  //   { columnName: "countNoCompleteOutDeadline", width: 100 },

  //   { columnName: "countComplete", width: 100 },
  //   { columnName: "countCompleteOutDeadline", width: 100 },

  //   { columnName: "countCompleteGo", width: 100 },
  //   { columnName: "waitting", width: 100 },
  //   { columnName: "release", width: 100 },

  //   { columnName: "countCompleteTask", width: 100 },
  //   { columnName: "waitTask", width: 100 },
  //   { columnName: "waittingTask", width: 100 },
  //   { columnName: "completeTask", width: 120 },
  // ],
  rightColumns: ['edit'],
  reload: false,
  perPage: 50,
