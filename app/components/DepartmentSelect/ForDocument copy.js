...
function DepartmentSelect(props) {
  ...
  function handleCheckDerpartment(name, valueName, checked) {
    console.log("handleCheckDerpartment", name, valueName, checked)
                  ...
                  >
                      ...
                      <>
                        ...
                        <Grid container xs={8} md={8} xl={8} style={{ justifyContent: 'space-between', alignItems: 'center' }}>
                          ...
                          <Grid item style={{ display: 'flex', justifyContent: 'center', maxWidth: '100px', width: '100px' }}>
                            ...
                            <>
                              {
                                columns && columns[0] && columns[0].name === 'view' && !columns[0].isColumnVirtual && <Checkbox
                                  onChange={() => {
                                    handleCheckUserAllReceive('processing');
                                  }}
                                  checked={checkAll.processing || false}
                    ...
                    {columns.map(it => (
                      <Grid item style={{ display: 'flex', justifyContent: 'center', maxWidth: '100px', width: '100px' }} >
                        ...
                        {!it.isColumnVirtual && ((processType === 'any' && allowSendToUnit && organizationUnit !== i._id && it.name !== "command") || (processType !== 'any' && role.processing_free_role_to_set && it.allowSelectDepartment && data[rowIndex] && data[rowIndex].allowedSelectDepartment)) ? (
                          <CheckDerpartment
