...
const FUNCTION_REORDER = [
  { code: 'Task', childCodes: ['TemplateTask', 'TaskConfig', 'TaskProcessFlow'] },
  {
    code: 'Document',
    childCodes: [
      'IncommingDocument',
  ...
  { code: 'AllCalendar', childCodes: ['Calendar', 'MeetingCalendar', 'MettingRoom', 'CalendarProcessFlow', 'CalendarConfig', 'Salary'] },
  { code: 'PlanWorking', childCodes: ['PersonPlan', 'OrganizationPlan', 'PlanProcessTemplate'] },
  { code: 'PhoneBook', childCodes: [] },
  // { code :'BookDocument', childCodes: ['AddBookDocument']},
  // { code: 'Letter', childCodes: ['People', 'Accused', 'LetterProcessFlow', 'LetterConfig', 'LetterComment'] },
  {
    code: 'reports',
    childCodes: ['reportsTaskStatus', 'reportDoingTask'],
  },
  { code: 'setting', childCodes: ['DynamicForm', 'Email', 'SMS', 'Employee'] },
];
let ALL_MODULES = [];
